<#
    .SYNOPSIS
        Creates a new dependency child
    .DESCRIPTION
        Creates a new dependency child
    ...
    .EXAMPLE
        New-CentreonDependencyChild -Dependency "my dependency" -ObjectName "Host1" -SubObjectName "Service1"
    ...
    .NOTES
        ...
        Version: 1.0
#>
function New-CentreonDependencyChild {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Dependency)) {
            foreach ($_dependency in $Dependency) {
                Invoke-Centreon -Object DEP -Action ADDCHILD -Value "$_dependency;$Object"
            }
        }
    }
    end {
