<#
    .SYNOPSIS
        Creates a new dependency parent
    .DESCRIPTION
        Creates a new dependency parent
    ...
    .EXAMPLE
        New-CentreonDependencyParent -Dependency "my dependency" -ObjectName "Host1" -SubObjectName "Service1"
    ...
    .NOTES
        ...
        Version: 1.0
#>
function New-CentreonDependencyParent {
    ...
    process {
        if ($PSCmdlet.ShouldProcess($Dependency)) {
            foreach ($_dependency in $Dependency) {
                Invoke-Centreon -Object DEP -Action ADDPARENT -Value "$_dependency;$Object"
            }
        }
    }
    end {
