<#
	.SYNOPSIS
		Installs the CentreonPowerShell Module from github
		
	.DESCRIPTION
		This script installs the CentreonPowerShell Module from github.
